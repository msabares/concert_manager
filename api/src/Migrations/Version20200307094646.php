 ...
 */
final class Version20200307094646 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        , password VARCHAR(255) NOT NULL COLLATE BINARY, name VARCHAR(255) DEFAULT NULL COLLATE BINARY, fav_color VARCHAR(255) DEFAULT NULL COLLATE BINARY)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE __temp__concert');
        $this->addSql('CREATE INDEX IDX_D57C02D27E3C61F9 ON concert (owner_id)');
        $this->addSql('ALTER TABLE user ADD COLUMN venue_list CLOB DEFAULT NULL COLLATE BINARY');
    }
}
